  ...
  return (
    <>
      <header
        ...
        style={{
          background: onHero ? (theme === 'dark' ? '#B71525' : '#ED1B36') : 'var(--color-surface)',
      ...
      >
        ...
        <Link href="/" className="flex items-center shrink-0 mr-6 py-2">
          <img src="/tarmac-logo-light.svg" alt="TARMAC Design System" className={(!onHero && theme === 'light') ? 'block' : 'hidden'} style={{ height: '18px', width: 'auto' }} />
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <a href="https://github.com/abhishekthakur3-sketch/TDS" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg transition-colors" style={{ color: onHero ? 'rgba(255,255,255,0.85)' : 'var(--color-on-surface-variant)' }} aria-label="GitHub">
          ...
          <button onClick={toggleTheme} className="p-2 rounded-lg transition-colors" style={{ color: onHero ? 'rgba(255,255,255,0.85)' : 'var(--color-on-surface-variant)' }} aria-label="Toggle theme">
            {theme === 'light' ? (

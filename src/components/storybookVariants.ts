...
export const storybookVariants: Record<string, StoryVariant[]> = {
  ...
  cards: [
    ...
    { id: 'tarmac-tds-card--card-full-matrix',             label: 'Card Full Matrix' },
    { id: 'tarmac-tds-card--light-vs-dark',                label: 'Light Vs Dark' },
    { id: 'tarmac-tds-card--variant-standard',             label: 'Variant Standard' },
    { id: 'tarmac-tds-card--variant-standard-type-2',      label: 'Variant Standard Type 2' },
    { id: 'tarmac-tds-card--variant-buttons-tacked',       label: 'Variant Buttons Tacked' },
    { id: 'tarmac-tds-card--variant-badge-bottom',         label: 'Variant Badge Bottom' },
    { id: 'tarmac-tds-card--info-card-playground',         label: 'Info Card Playground' },
    { id: 'tarmac-tds-card--info-card-full-matrix',        label: 'Info Card Full Matrix' },
    { id: 'tarmac-tds-card--selection-card-playground',    label: 'Selection Card Playground' },
    { id: 'tarmac-tds-card--selection-card-full-matrix',   label: 'Selection Card Full Matrix' },
    { id: 'tarmac-tds-card--checkbox-type',                label: 'Checkbox Type' },
  ],
  ...
  /* ── Dropdown ──────────────────────────────────────────────── */
  dropdown: [
    { id: 'tarmac-tds-dropdown--list-playground',          label: 'List Playground' },
    { id: 'tarmac-tds-dropdown--list-size-comparison',     label: 'List Size Comparison' },
    { id: 'tarmac-tds-dropdown--list-variants',            label: 'List Variants' },
    { id: 'tarmac-tds-dropdown--full-matrix',              label: 'Full Matrix' },
    { id: 'tarmac-tds-dropdown--light-vs-dark',            label: 'Light Vs Dark' },
    { id: 'tarmac-tds-dropdown--playground',               label: 'Playground' },
    { id: 'tarmac-tds-dropdown--default-type',             label: 'Default Type' },
    { id: 'tarmac-tds-dropdown--multi-select',             label: 'Multi Select' },
    { id: 'tarmac-tds-dropdown--searchable',               label: 'Searchable' },
    { id: 'tarmac-tds-dropdown--grouped-options',          label: 'Grouped Options' },
    { id: 'tarmac-tds-dropdown--footer-ct-as',             label: 'Footer CTAs' },
  ],
